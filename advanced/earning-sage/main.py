...
class EarningSage_Retriver(Photon):
    ...
    def ui(self):
        ...
        with blocks:
            ...
            with gr.Row():
                msg = gr.Textbox(
                    value="What do you think of the relationship between Apple and it's customers?",
            ...
            button1 = gr.Button("Can you discuss the potential for further growth in the number of Apple devices per iPhone user?")
            ...
            def send_button_clicked(x):
                return gr.update(value='''Can you discuss the potential for further growth in the number of Apple devices per iPhone user? Additionally, could you elaborate on how the monetization per user might vary between highly engaged "super users" and those who are not as deeply integrated into the Apple ecosystem?''')
